...
$idpay_payment = "<div style=\'display: flex;justify-content: center\'><div class=\'bank_paymnt\' title=\'idpay\' style=\'margin: 5px 5px;cursor: pointer;ppadding: 5px; background: #eee; border-radius: 5px; border: 4px solid #ddd; width: 150px; position: relative; padding: 15px 0;\'><img width=\'150\' style=\'margin: auto;\' src=\'$site_url/wp-content/plugins/idpay-wp-estimation-form/assets/logo.svg\'><h3 style=\'font-size: 13px; margin: 5px 0;\'>درگاه آیدی پی</h3></div></div>";
